...
\restrict luVrFkPSmYIgahapZssZkhyxFlEkPphhh1NJfgaL5GmZf9inW1EvDeYo2EexBw2
...
DROP POLICY IF EXISTS video_telemetric_orgs ON public.video_telemetric;
DROP POLICY IF EXISTS video_orgs ON public.video;
DROP POLICY IF EXISTS users_user ON public.users;
DROP POLICY IF EXISTS users_policy ON public.users;
DROP POLICY IF EXISTS user_subject_orgs ON public.user_subject;
DROP POLICY IF EXISTS user_subject_assignment_orgs ON public.user_subject_assignment;
DROP POLICY IF EXISTS user_group_orgs ON public.user_group;
DROP POLICY IF EXISTS translation_orgs ON public.translation;
DROP POLICY IF EXISTS task_unassignment_orgs ON public.task_unassignment;
DROP POLICY IF EXISTS task_type_orgs ON public.task_type;
DROP POLICY IF EXISTS task_status_orgs ON public.task_status;
DROP POLICY IF EXISTS task_orgs ON public.task;
DROP POLICY IF EXISTS table_metadata_rls_policy ON public.table_metadata;
DROP POLICY IF EXISTS sync_telemetry_orgs ON public.sync_telemetry;
DROP POLICY IF EXISTS subject_type_orgs ON public.subject_type;
DROP POLICY IF EXISTS subject_program_eligibility_orgs ON public.subject_program_eligibility;
DROP POLICY IF EXISTS subject_migration_orgs ON public.subject_migration;
DROP POLICY IF EXISTS rule_orgs ON public.rule;
DROP POLICY IF EXISTS rule_failure_telemetry_orgs ON public.rule_failure_telemetry;
DROP POLICY IF EXISTS rule_dependency_orgs ON public.rule_dependency;
DROP POLICY IF EXISTS reset_sync_orgs ON public.reset_sync;
DROP POLICY IF EXISTS program_outcome_orgs ON public.program_outcome;
DROP POLICY IF EXISTS program_orgs ON public.program;
DROP POLICY IF EXISTS program_enrolment_orgs ON public.program_enrolment;
DROP POLICY IF EXISTS program_encounter_orgs ON public.program_encounter;
DROP POLICY IF EXISTS post_etl_sync_status_rls_policy ON public.post_etl_sync_status;
DROP POLICY IF EXISTS organisation_policy ON public.organisation;
DROP POLICY IF EXISTS organisation_group_policy ON public.organisation_group;
DROP POLICY IF EXISTS organisation_group_organisation_policy ON public.organisation_group_organisation;
DROP POLICY IF EXISTS organisation_config_orgs ON public.organisation_config;
DROP POLICY IF EXISTS operational_subject_type_orgs ON public.operational_subject_type;
DROP POLICY IF EXISTS operational_program_orgs ON public.operational_program;
DROP POLICY IF EXISTS operational_encounter_type_orgs ON public.operational_encounter_type;
DROP POLICY IF EXISTS non_applicable_form_element_orgs ON public.non_applicable_form_element;
DROP POLICY IF EXISTS news_orgs ON public.news;
DROP POLICY IF EXISTS msg91_config_orgs ON public.msg91_config;
DROP POLICY IF EXISTS message_rule_orgs ON public.message_rule;
DROP POLICY IF EXISTS message_request_queue_orgs ON public.message_request_queue;
DROP POLICY IF EXISTS message_receiver_orgs ON public.message_receiver;
DROP POLICY IF EXISTS menu_item_orgs ON public.menu_item;
DROP POLICY IF EXISTS manual_broadcast_message_orgs ON public.manual_message;
DROP POLICY IF EXISTS location_location_mapping_orgs ON public.location_location_mapping;
DROP POLICY IF EXISTS individual_relationship_type_orgs ON public.individual_relationship_type;
DROP POLICY IF EXISTS individual_relationship_orgs ON public.individual_relationship;
DROP POLICY IF EXISTS individual_relation_orgs ON public.individual_relation;
DROP POLICY IF EXISTS individual_relation_gender_mapping_orgs ON public.individual_relation_gender_mapping;
DROP POLICY IF EXISTS individual_orgs ON public.individual;
DROP POLICY IF EXISTS identifier_user_assignment_orgs ON public.identifier_user_assignment;
DROP POLICY IF EXISTS identifier_source_orgs ON public.identifier_source;
DROP POLICY IF EXISTS identifier_assignment_orgs ON public.identifier_assignment;
DROP POLICY IF EXISTS groups_orgs ON public.groups;
DROP POLICY IF EXISTS group_subject_orgs ON public.group_subject;
DROP POLICY IF EXISTS group_role_orgs ON public.group_role;
DROP POLICY IF EXISTS group_privilege_orgs ON public.group_privilege;
DROP POLICY IF EXISTS group_dashboard_orgs ON public.group_dashboard;
DROP POLICY IF EXISTS gender_orgs ON public.gender;
DROP POLICY IF EXISTS form_orgs ON public.form;
DROP POLICY IF EXISTS form_mapping_orgs ON public.form_mapping;
DROP POLICY IF EXISTS form_element_orgs ON public.form_element;
DROP POLICY IF EXISTS form_element_group_orgs ON public.form_element_group;
DROP POLICY IF EXISTS flow_request_queue_orgs ON public.flow_request_queue;
DROP POLICY IF EXISTS facility_orgs ON public.facility;
DROP POLICY IF EXISTS external_system_config_orgs ON public.external_system_config;
DROP POLICY IF EXISTS export_job_parameters_orgs ON public.export_job_parameters;
DROP POLICY IF EXISTS entity_sync_status_rls_policy ON public.entity_sync_status;
DROP POLICY IF EXISTS entity_approval_status_orgs ON public.entity_approval_status;
DROP POLICY IF EXISTS encounter_type_orgs ON public.encounter_type;
DROP POLICY IF EXISTS encounter_orgs ON public.encounter;
DROP POLICY IF EXISTS documentation_orgs ON public.documentation;
DROP POLICY IF EXISTS documentation_item_orgs ON public.documentation_item;
DROP POLICY IF EXISTS dashboard_section_orgs ON public.dashboard_section;
DROP POLICY IF EXISTS dashboard_section_card_mapping_orgs ON public.dashboard_section_card_mapping;
DROP POLICY IF EXISTS dashboard_orgs ON public.dashboard;
DROP POLICY IF EXISTS dashboard_filter_orgs ON public.dashboard_filter;
DROP POLICY IF EXISTS dashboard_card_mapping_orgs ON public.dashboard_card_mapping;
DROP POLICY IF EXISTS custom_query_orgs ON public.custom_query;
DROP POLICY IF EXISTS concept_orgs ON public.concept;
DROP POLICY IF EXISTS concept_answer_orgs ON public.concept_answer;
DROP POLICY IF EXISTS comment_thread_orgs ON public.comment_thread;
DROP POLICY IF EXISTS comment_orgs ON public.comment;
DROP POLICY IF EXISTS column_metadata_rls_policy ON public.column_metadata;
DROP POLICY IF EXISTS checklist_orgs ON public.checklist;
DROP POLICY IF EXISTS checklist_item_orgs ON public.checklist_item;
DROP POLICY IF EXISTS checklist_item_detail_orgs ON public.checklist_item_detail;
DROP POLICY IF EXISTS checklist_detail_orgs ON public.checklist_detail;
DROP POLICY IF EXISTS catchment_orgs ON public.catchment;
DROP POLICY IF EXISTS card_orgs ON public.report_card;
DROP POLICY IF EXISTS archival_config_orgs ON public.storage_management_config;
DROP POLICY IF EXISTS answer_concept_migration_orgs ON public.answer_concept_migration;
DROP POLICY IF EXISTS address_level_type_orgs ON public.address_level_type;
DROP POLICY IF EXISTS address_level_orgs ON public.address_level;
ALTER TABLE IF EXISTS ONLY public.video_telemetric DROP CONSTRAINT IF EXISTS video_telemetric_video;
ALTER TABLE IF EXISTS ONLY public.video_telemetric DROP CONSTRAINT IF EXISTS video_telemetric_user;
ALTER TABLE IF EXISTS ONLY public.video_telemetric DROP CONSTRAINT IF EXISTS video_telemetric_organisation;
ALTER TABLE IF EXISTS ONLY public.video DROP CONSTRAINT IF EXISTS video_organisation;
ALTER TABLE IF EXISTS ONLY public.video DROP CONSTRAINT IF EXISTS video_audit;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_subject_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_subject_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_group DROP CONSTRAINT IF EXISTS user_group_user_id;
ALTER TABLE IF EXISTS ONLY public.user_group DROP CONSTRAINT IF EXISTS user_group_organisation;
ALTER TABLE IF EXISTS ONLY public.user_group DROP CONSTRAINT IF EXISTS user_group_master_audit;
ALTER TABLE IF EXISTS ONLY public.user_group DROP CONSTRAINT IF EXISTS user_group_group_id;
ALTER TABLE IF EXISTS ONLY public.translation DROP CONSTRAINT IF EXISTS translation_organisation;
ALTER TABLE IF EXISTS ONLY public.translation DROP CONSTRAINT IF EXISTS translation_master_audit;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_organisation_fk;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_last_modified_by_user_fk;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_created_by_user_fk;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_unassigned_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_task_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_type DROP CONSTRAINT IF EXISTS task_type_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_type DROP CONSTRAINT IF EXISTS task_type_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_type DROP CONSTRAINT IF EXISTS task_type_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_task_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_task_status_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_subject_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_status DROP CONSTRAINT IF EXISTS task_status_task_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_status DROP CONSTRAINT IF EXISTS task_status_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_status DROP CONSTRAINT IF EXISTS task_status_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_status DROP CONSTRAINT IF EXISTS task_status_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_assigned_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sync_telemetry DROP CONSTRAINT IF EXISTS sync_telemetry_user;
ALTER TABLE IF EXISTS ONLY public.sync_telemetry DROP CONSTRAINT IF EXISTS sync_telemetry_organisation;
ALTER TABLE IF EXISTS ONLY public.subject_type DROP CONSTRAINT IF EXISTS subject_type_organisation;
ALTER TABLE IF EXISTS ONLY public.subject_type DROP CONSTRAINT IF EXISTS subject_type_audit;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_subject_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_program_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_subject_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_old_address_level_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_new_address_level_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_individual_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.batch_step_execution_context DROP CONSTRAINT IF EXISTS step_exec_ctx_fk;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS rule_rule_dependency_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS rule_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rule_failure_telemetry DROP CONSTRAINT IF EXISTS rule_failure_telemetry_user;
ALTER TABLE IF EXISTS ONLY public.rule_failure_telemetry DROP CONSTRAINT IF EXISTS rule_failure_telemetry_organisation;
ALTER TABLE IF EXISTS ONLY public.rule_failure_telemetry DROP CONSTRAINT IF EXISTS rule_failure_telemetry_master_audit;
ALTER TABLE IF EXISTS ONLY public.rule_dependency DROP CONSTRAINT IF EXISTS rule_dependency_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS rule_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reset_sync DROP CONSTRAINT IF EXISTS reset_sync_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reset_sync DROP CONSTRAINT IF EXISTS reset_sync_subject_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reset_sync DROP CONSTRAINT IF EXISTS reset_sync_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.report_card DROP CONSTRAINT IF EXISTS report_card_standard_report_card_type;
...
ALTER TABLE IF EXISTS ONLY public.program_outcome DROP CONSTRAINT IF EXISTS program_outcome_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.program_outcome DROP CONSTRAINT IF EXISTS program_outcome_audit;
ALTER TABLE IF EXISTS ONLY public.program DROP CONSTRAINT IF EXISTS program_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_program;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_individual;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_audit;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_program_enrolment;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_filled_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_encounter_type;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_audit;
ALTER TABLE IF EXISTS ONLY public.program DROP CONSTRAINT IF EXISTS program_audit;
ALTER TABLE IF EXISTS ONLY public.platform_translation DROP CONSTRAINT IF EXISTS platform_translation_audit;
ALTER TABLE IF EXISTS ONLY public.organisation DROP CONSTRAINT IF EXISTS organisation_parent_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organisation_group_organisation DROP CONSTRAINT IF EXISTS organisation_group_organisation_organisation_group;
ALTER TABLE IF EXISTS ONLY public.organisation_group_organisation DROP CONSTRAINT IF EXISTS organisation_group_organisation_organisation;
ALTER TABLE IF EXISTS ONLY public.organisation_group DROP CONSTRAINT IF EXISTS organisation_group_account;
ALTER TABLE IF EXISTS ONLY public.organisation_config DROP CONSTRAINT IF EXISTS organisation_config_organisation;
ALTER TABLE IF EXISTS ONLY public.organisation_config DROP CONSTRAINT IF EXISTS organisation_config_master_audit;
ALTER TABLE IF EXISTS ONLY public.organisation DROP CONSTRAINT IF EXISTS organisation_account;
ALTER TABLE IF EXISTS ONLY public.operational_subject_type DROP CONSTRAINT IF EXISTS operational_subject_type_subject_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.operational_subject_type DROP CONSTRAINT IF EXISTS operational_subject_type_organisation;
ALTER TABLE IF EXISTS ONLY public.operational_subject_type DROP CONSTRAINT IF EXISTS operational_subject_type_audit;
ALTER TABLE IF EXISTS ONLY public.operational_program DROP CONSTRAINT IF EXISTS operational_program_program_id_fkey;
ALTER TABLE IF EXISTS ONLY public.operational_program DROP CONSTRAINT IF EXISTS operational_program_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.operational_program DROP CONSTRAINT IF EXISTS operational_program_audit;
ALTER TABLE IF EXISTS ONLY public.operational_encounter_type DROP CONSTRAINT IF EXISTS operational_encounter_type_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.operational_encounter_type DROP CONSTRAINT IF EXISTS operational_encounter_type_encounter_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.operational_encounter_type DROP CONSTRAINT IF EXISTS operational_encounter_type_audit;
ALTER TABLE IF EXISTS ONLY public.non_applicable_form_element DROP CONSTRAINT IF EXISTS non_applicable_form_element_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.non_applicable_form_element DROP CONSTRAINT IF EXISTS non_applicable_form_element_form_element_id_fkey;
ALTER TABLE IF EXISTS ONLY public.non_applicable_form_element DROP CONSTRAINT IF EXISTS non_applicable_form_element_audit;
ALTER TABLE IF EXISTS ONLY public.news DROP CONSTRAINT IF EXISTS news_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.news DROP CONSTRAINT IF EXISTS news_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.msg91_config DROP CONSTRAINT IF EXISTS msg91_config_organisation;
ALTER TABLE IF EXISTS ONLY public.msg91_config DROP CONSTRAINT IF EXISTS msg91_config_audit;
ALTER TABLE IF EXISTS ONLY public.message_rule DROP CONSTRAINT IF EXISTS message_rule_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_rule DROP CONSTRAINT IF EXISTS message_rule_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_rule DROP CONSTRAINT IF EXISTS message_rule_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_message_rule_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_message_receiver_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_manual_broadcast_message_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_receiver DROP CONSTRAINT IF EXISTS message_receiver_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_receiver DROP CONSTRAINT IF EXISTS message_receiver_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.message_receiver DROP CONSTRAINT IF EXISTS message_receiver_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.menu_item DROP CONSTRAINT IF EXISTS menu_item_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.menu_item DROP CONSTRAINT IF EXISTS menu_item_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.menu_item DROP CONSTRAINT IF EXISTS menu_item_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.manual_message DROP CONSTRAINT IF EXISTS manual_broadcast_message_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.manual_message DROP CONSTRAINT IF EXISTS manual_broadcast_message_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.manual_message DROP CONSTRAINT IF EXISTS manual_broadcast_message_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.location_location_mapping DROP CONSTRAINT IF EXISTS location_location_mapping_parent_location;
ALTER TABLE IF EXISTS ONLY public.location_location_mapping DROP CONSTRAINT IF EXISTS location_location_mapping_organisation;
ALTER TABLE IF EXISTS ONLY public.location_location_mapping DROP CONSTRAINT IF EXISTS location_location_mapping_location;
ALTER TABLE IF EXISTS ONLY public.location_location_mapping DROP CONSTRAINT IF EXISTS location_location_mapping_audit;
...
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_subject_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.individual_relative DROP CONSTRAINT IF EXISTS individual_relative_relative_individual;
ALTER TABLE IF EXISTS ONLY public.individual_relative DROP CONSTRAINT IF EXISTS individual_relative_individual;
ALTER TABLE IF EXISTS ONLY public.individual_relationship_type DROP CONSTRAINT IF EXISTS individual_relationship_type_individual_b_relation;
ALTER TABLE IF EXISTS ONLY public.individual_relationship_type DROP CONSTRAINT IF EXISTS individual_relationship_type_individual_a_relation;
ALTER TABLE IF EXISTS ONLY public.individual_relationship_type DROP CONSTRAINT IF EXISTS individual_relationship_type_audit;
ALTER TABLE IF EXISTS ONLY public.individual_relationship DROP CONSTRAINT IF EXISTS individual_relationship_relation_type;
ALTER TABLE IF EXISTS ONLY public.individual_relationship DROP CONSTRAINT IF EXISTS individual_relationship_individual_b;
ALTER TABLE IF EXISTS ONLY public.individual_relationship DROP CONSTRAINT IF EXISTS individual_relationship_individual_a;
ALTER TABLE IF EXISTS ONLY public.individual_relationship DROP CONSTRAINT IF EXISTS individual_relationship_audit;
ALTER TABLE IF EXISTS ONLY public.individual_relation_gender_mapping DROP CONSTRAINT IF EXISTS individual_relation_gender_mapping_relation;
ALTER TABLE IF EXISTS ONLY public.individual_relation_gender_mapping DROP CONSTRAINT IF EXISTS individual_relation_gender_mapping_gender;
ALTER TABLE IF EXISTS ONLY public.individual_relation_gender_mapping DROP CONSTRAINT IF EXISTS individual_relation_gender_mapping_audit;
ALTER TABLE IF EXISTS ONLY public.individual_relative DROP CONSTRAINT IF EXISTS individual_relation_audit;
ALTER TABLE IF EXISTS ONLY public.individual_relation DROP CONSTRAINT IF EXISTS individual_relation_audit;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_gender;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_facility;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_audit;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_address;
ALTER TABLE IF EXISTS ONLY public.index_metadata DROP CONSTRAINT IF EXISTS index_metadata_table_metadata_id_fkey;
ALTER TABLE IF EXISTS ONLY public.index_metadata DROP CONSTRAINT IF EXISTS index_metadata_column_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_identifier_source_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_assigned_to_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_source DROP CONSTRAINT IF EXISTS identifier_source_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_source DROP CONSTRAINT IF EXISTS identifier_source_catchment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_source DROP CONSTRAINT IF EXISTS identifier_source_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_program_enrolment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_individual_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_identifier_source_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_assigned_to_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_organisation;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_member_subject;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_master_audit;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_group_subject;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_group_role;
ALTER TABLE IF EXISTS ONLY public.group_role DROP CONSTRAINT IF EXISTS group_role_organisation;
ALTER TABLE IF EXISTS ONLY public.group_role DROP CONSTRAINT IF EXISTS group_role_member_subject_type;
ALTER TABLE IF EXISTS ONLY public.group_role DROP CONSTRAINT IF EXISTS group_role_master_audit;
ALTER TABLE IF EXISTS ONLY public.group_role DROP CONSTRAINT IF EXISTS group_role_group_subject_type;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_subject_id;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_program_id;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_program_encounter_type_id;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_organisation;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_master_audit;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_group_id;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_encounter_type_id;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_checklist_detail_id;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS group_organisation;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS group_master_audit;
ALTER TABLE IF EXISTS ONLY public.group_dashboard DROP CONSTRAINT IF EXISTS group_dashboard_organisation;
ALTER TABLE IF EXISTS ONLY public.group_dashboard DROP CONSTRAINT IF EXISTS group_dashboard_group;
ALTER TABLE IF EXISTS ONLY public.group_dashboard DROP CONSTRAINT IF EXISTS group_dashboard_dashboard;
ALTER TABLE IF EXISTS ONLY public.group_dashboard DROP CONSTRAINT IF EXISTS group_dashboard_audit;
ALTER TABLE IF EXISTS ONLY public.gender DROP CONSTRAINT IF EXISTS gender_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gender DROP CONSTRAINT IF EXISTS gender_concept;
ALTER TABLE IF EXISTS ONLY public.gender DROP CONSTRAINT IF EXISTS gender_audit;
ALTER TABLE IF EXISTS ONLY public.form DROP CONSTRAINT IF EXISTS form_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_task_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_subject_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_form;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_audit;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_element_group DROP CONSTRAINT IF EXISTS form_element_group_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_group_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_element_group DROP CONSTRAINT IF EXISTS form_element_group_form;
ALTER TABLE IF EXISTS ONLY public.form_element_group DROP CONSTRAINT IF EXISTS form_element_group_audit;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_form_element_group;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_documentation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_concept;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_audit;
ALTER TABLE IF EXISTS ONLY public.form DROP CONSTRAINT IF EXISTS form_audit;
ALTER TABLE IF EXISTS ONLY public.flow_request_queue DROP CONSTRAINT IF EXISTS flow_request_queue_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flow_request_queue DROP CONSTRAINT IF EXISTS flow_request_queue_message_receiver_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flow_request_queue DROP CONSTRAINT IF EXISTS flow_request_queue_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flow_request_queue DROP CONSTRAINT IF EXISTS flow_request_queue_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.facility DROP CONSTRAINT IF EXISTS facility_address;
ALTER TABLE IF EXISTS ONLY public.external_system_config DROP CONSTRAINT IF EXISTS external_system_config_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.external_system_config DROP CONSTRAINT IF EXISTS external_system_config_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.external_system_config DROP CONSTRAINT IF EXISTS external_system_config_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.export_job_parameters DROP CONSTRAINT IF EXISTS export_job_parameters_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.export_job_parameters DROP CONSTRAINT IF EXISTS export_job_parameters_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.export_job_parameters DROP CONSTRAINT IF EXISTS export_job_parameters_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.export_job_parameters DROP CONSTRAINT IF EXISTS export_job_parameters_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.entity_sync_status DROP CONSTRAINT IF EXISTS entity_sync_status_table_metadata_id_fkey;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_organisation;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_individual_id;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_audit;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_approval_status;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_address_id;
ALTER TABLE IF EXISTS ONLY public.encounter_type DROP CONSTRAINT IF EXISTS encounter_type_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.encounter_type DROP CONSTRAINT IF EXISTS encounter_type_concept;
ALTER TABLE IF EXISTS ONLY public.encounter_type DROP CONSTRAINT IF EXISTS encounter_type_audit;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_individual;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_filled_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_encounter_type;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_audit;
ALTER TABLE IF EXISTS ONLY public.documentation DROP CONSTRAINT IF EXISTS documentation_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.documentation DROP CONSTRAINT IF EXISTS documentation_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.documentation_item DROP CONSTRAINT IF EXISTS documentation_item_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.documentation_item DROP CONSTRAINT IF EXISTS documentation_item_documentation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.decision_concept DROP CONSTRAINT IF EXISTS decision_concept_form;
ALTER TABLE IF EXISTS ONLY public.decision_concept DROP CONSTRAINT IF EXISTS decision_concept_concept;
ALTER TABLE IF EXISTS ONLY public.dashboard_section DROP CONSTRAINT IF EXISTS dashboard_section_organisation;
ALTER TABLE IF EXISTS ONLY public.dashboard_section DROP CONSTRAINT IF EXISTS dashboard_section_dashboard;
ALTER TABLE IF EXISTS ONLY public.dashboard_section_card_mapping DROP CONSTRAINT IF EXISTS dashboard_section_card_mapping_organisation;
ALTER TABLE IF EXISTS ONLY public.dashboard_section_card_mapping DROP CONSTRAINT IF EXISTS dashboard_section_card_mapping_dashboard;
ALTER TABLE IF EXISTS ONLY public.dashboard_section_card_mapping DROP CONSTRAINT IF EXISTS dashboard_section_card_mapping_card;
ALTER TABLE IF EXISTS ONLY public.dashboard_section_card_mapping DROP CONSTRAINT IF EXISTS dashboard_section_card_mapping_audit;
ALTER TABLE IF EXISTS ONLY public.dashboard_section DROP CONSTRAINT IF EXISTS dashboard_section_audit;
ALTER TABLE IF EXISTS ONLY public.dashboard DROP CONSTRAINT IF EXISTS dashboard_organisation;
ALTER TABLE IF EXISTS ONLY public.dashboard DROP CONSTRAINT IF EXISTS dashboard_master_audit;
ALTER TABLE IF EXISTS ONLY public.dashboard_filter DROP CONSTRAINT IF EXISTS dashboard_filter_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_filter DROP CONSTRAINT IF EXISTS dashboard_filter_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_filter DROP CONSTRAINT IF EXISTS dashboard_filter_dashboard_id_fkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_filter DROP CONSTRAINT IF EXISTS dashboard_filter_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_card_mapping DROP CONSTRAINT IF EXISTS dashboard_card_organisation;
ALTER TABLE IF EXISTS ONLY public.dashboard_card_mapping DROP CONSTRAINT IF EXISTS dashboard_card_master_audit;
ALTER TABLE IF EXISTS ONLY public.dashboard_card_mapping DROP CONSTRAINT IF EXISTS dashboard_card_dashboard;
ALTER TABLE IF EXISTS ONLY public.dashboard_card_mapping DROP CONSTRAINT IF EXISTS dashboard_card_card;
ALTER TABLE IF EXISTS ONLY public.custom_query DROP CONSTRAINT IF EXISTS custom_query_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.custom_query DROP CONSTRAINT IF EXISTS custom_query_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.custom_query DROP CONSTRAINT IF EXISTS custom_query_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.concept DROP CONSTRAINT IF EXISTS concept_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.concept DROP CONSTRAINT IF EXISTS concept_audit;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_concept;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_audit;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_answer_concept;
ALTER TABLE IF EXISTS ONLY public.comment_thread DROP CONSTRAINT IF EXISTS comment_thread_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.comment_thread DROP CONSTRAINT IF EXISTS comment_thread_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.comment DROP CONSTRAINT IF EXISTS comment_subject_id_fkey;
ALTER TABLE IF EXISTS ONLY public.comment DROP CONSTRAINT IF EXISTS comment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.comment DROP CONSTRAINT IF EXISTS comment_comment_thread_id_fkey;
ALTER TABLE IF EXISTS ONLY public.comment DROP CONSTRAINT IF EXISTS comment_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.column_metadata DROP CONSTRAINT IF EXISTS column_metadata_table_id_fkey;
ALTER TABLE IF EXISTS ONLY public.column_metadata DROP CONSTRAINT IF EXISTS column_metadata_concept_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_program_enrolment;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item DROP CONSTRAINT IF EXISTS checklist_item_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_form_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_dependent_on_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_concept_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_checklist_detail_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_audit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item DROP CONSTRAINT IF EXISTS checklist_item_checklist_item_detail_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item DROP CONSTRAINT IF EXISTS checklist_item_checklist;
ALTER TABLE IF EXISTS ONLY public.checklist_item DROP CONSTRAINT IF EXISTS checklist_item_audit;
ALTER TABLE IF EXISTS ONLY public.checklist_detail DROP CONSTRAINT IF EXISTS checklist_detail_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_checklist_detail_id_fkey;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_audit;
ALTER TABLE IF EXISTS ONLY public.catchment DROP CONSTRAINT IF EXISTS catchment_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.catchment DROP CONSTRAINT IF EXISTS catchment_audit;
ALTER TABLE IF EXISTS ONLY public.catchment_address_mapping DROP CONSTRAINT IF EXISTS catchment_address_mapping_catchment;
ALTER TABLE IF EXISTS ONLY public.catchment_address_mapping DROP CONSTRAINT IF EXISTS catchment_address_mapping_address;
ALTER TABLE IF EXISTS ONLY public.report_card DROP CONSTRAINT IF EXISTS card_organisation;
ALTER TABLE IF EXISTS ONLY public.report_card DROP CONSTRAINT IF EXISTS card_master_audit;
ALTER TABLE IF EXISTS ONLY public.storage_management_config DROP CONSTRAINT IF EXISTS archival_config_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.storage_management_config DROP CONSTRAINT IF EXISTS archival_config_last_modified_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.storage_management_config DROP CONSTRAINT IF EXISTS archival_config_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.answer_concept_migration DROP CONSTRAINT IF EXISTS answer_concept_migration_concept_id_fkey;
ALTER TABLE IF EXISTS ONLY public.address_level_type DROP CONSTRAINT IF EXISTS address_level_type_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_audit;
ALTER TABLE IF EXISTS ONLY public.account_admin DROP CONSTRAINT IF EXISTS account_admin_user;
ALTER TABLE IF EXISTS ONLY public.account_admin DROP CONSTRAINT IF EXISTS account_admin_account;
DROP TRIGGER IF EXISTS video_update_audit_before_update ON public.video;
DROP TRIGGER IF EXISTS video_update_audit_before_insert ON public.video;
DROP TRIGGER IF EXISTS user_group_update_audit_before_update ON public.user_group;
DROP TRIGGER IF EXISTS user_group_update_audit_before_insert ON public.user_group;
DROP TRIGGER IF EXISTS translation_update_audit_before_update ON public.translation;
DROP TRIGGER IF EXISTS translation_update_audit_before_insert ON public.translation;
DROP TRIGGER IF EXISTS subject_type_update_audit_before_update ON public.subject_type;
DROP TRIGGER IF EXISTS subject_type_update_audit_before_insert ON public.subject_type;
DROP TRIGGER IF EXISTS subject_migration_update_audit_before_update ON public.subject_migration;
DROP TRIGGER IF EXISTS subject_migration_update_audit_before_insert ON public.subject_migration;
DROP TRIGGER IF EXISTS rule_update_audit_before_update ON public.rule;
DROP TRIGGER IF EXISTS rule_update_audit_before_insert ON public.rule;
DROP TRIGGER IF EXISTS rule_failure_telemetry_update_audit_before_update ON public.rule_failure_telemetry;
DROP TRIGGER IF EXISTS rule_failure_telemetry_update_audit_before_insert ON public.rule_failure_telemetry;
DROP TRIGGER IF EXISTS rule_failure_log_update_audit_before_update ON public.rule_failure_log;
DROP TRIGGER IF EXISTS rule_failure_log_update_audit_before_insert ON public.rule_failure_log;
DROP TRIGGER IF EXISTS rule_dependency_update_audit_before_update ON public.rule_dependency;
DROP TRIGGER IF EXISTS rule_dependency_update_audit_before_insert ON public.rule_dependency;
DROP TRIGGER IF EXISTS report_card_update_audit_before_update ON public.report_card;
DROP TRIGGER IF EXISTS report_card_update_audit_before_insert ON public.report_card;
DROP TRIGGER IF EXISTS program_update_audit_before_update ON public.program;
DROP TRIGGER IF EXISTS program_update_audit_before_insert ON public.program;
DROP TRIGGER IF EXISTS program_outcome_update_audit_before_update ON public.program_outcome;
DROP TRIGGER IF EXISTS program_outcome_update_audit_before_insert ON public.program_outcome;
DROP TRIGGER IF EXISTS program_enrolment_update_audit_before_update ON public.program_enrolment;
DROP TRIGGER IF EXISTS program_enrolment_update_audit_before_insert ON public.program_enrolment;
DROP TRIGGER IF EXISTS program_encounter_update_audit_before_update ON public.program_encounter;
DROP TRIGGER IF EXISTS program_encounter_update_audit_before_insert ON public.program_encounter;
DROP TRIGGER IF EXISTS platform_translation_update_audit_before_update ON public.platform_translation;
DROP TRIGGER IF EXISTS platform_translation_update_audit_before_insert ON public.platform_translation;
DROP TRIGGER IF EXISTS organisation_config_update_audit_before_update ON public.organisation_config;
DROP TRIGGER IF EXISTS organisation_config_update_audit_before_insert ON public.organisation_config;
DROP TRIGGER IF EXISTS operational_subject_type_update_audit_before_update ON public.operational_subject_type;
DROP TRIGGER IF EXISTS operational_subject_type_update_audit_before_insert ON public.operational_subject_type;
DROP TRIGGER IF EXISTS operational_program_update_audit_before_update ON public.operational_program;
DROP TRIGGER IF EXISTS operational_program_update_audit_before_insert ON public.operational_program;
DROP TRIGGER IF EXISTS operational_encounter_type_update_audit_before_update ON public.operational_encounter_type;
DROP TRIGGER IF EXISTS operational_encounter_type_update_audit_before_insert ON public.operational_encounter_type;
DROP TRIGGER IF EXISTS non_applicable_form_element_update_audit_before_update ON public.non_applicable_form_element;
DROP TRIGGER IF EXISTS non_applicable_form_element_update_audit_before_insert ON public.non_applicable_form_element;
DROP TRIGGER IF EXISTS news_update_audit_before_update ON public.news;
DROP TRIGGER IF EXISTS news_update_audit_before_insert ON public.news;
DROP TRIGGER IF EXISTS msg91_config_update_audit_before_update ON public.msg91_config;
DROP TRIGGER IF EXISTS msg91_config_update_audit_before_insert ON public.msg91_config;
DROP TRIGGER IF EXISTS location_location_mapping_update_audit_before_update ON public.location_location_mapping;
DROP TRIGGER IF EXISTS location_location_mapping_update_audit_before_insert ON public.location_location_mapping;
DROP TRIGGER IF EXISTS individual_update_audit_before_update ON public.individual;
DROP TRIGGER IF EXISTS individual_update_audit_before_insert ON public.individual;
DROP TRIGGER IF EXISTS individual_relative_update_audit_before_update ON public.individual_relative;
DROP TRIGGER IF EXISTS individual_relative_update_audit_before_insert ON public.individual_relative;
DROP TRIGGER IF EXISTS individual_relationship_update_audit_before_update ON public.individual_relationship;
DROP TRIGGER IF EXISTS individual_relationship_update_audit_before_insert ON public.individual_relationship;
DROP TRIGGER IF EXISTS individual_relationship_type_update_audit_before_update ON public.individual_relationship_type;
DROP TRIGGER IF EXISTS individual_relationship_type_update_audit_before_insert ON public.individual_relationship_type;
DROP TRIGGER IF EXISTS individual_relation_update_audit_before_update ON public.individual_relation;
DROP TRIGGER IF EXISTS individual_relation_update_audit_before_insert ON public.individual_relation;
DROP TRIGGER IF EXISTS individual_relation_gender_mapping_update_audit_before_update ON public.individual_relation_gender_mapping;
DROP TRIGGER IF EXISTS individual_relation_gender_mapping_update_audit_before_insert ON public.individual_relation_gender_mapping;
DROP TRIGGER IF EXISTS identifier_user_assignment_update_audit_before_update ON public.identifier_user_assignment;
DROP TRIGGER IF EXISTS identifier_user_assignment_update_audit_before_insert ON public.identifier_user_assignment;
DROP TRIGGER IF EXISTS identifier_source_update_audit_before_update ON public.identifier_source;
DROP TRIGGER IF EXISTS identifier_source_update_audit_before_insert ON public.identifier_source;
DROP TRIGGER IF EXISTS identifier_assignment_update_audit_before_update ON public.identifier_assignment;
DROP TRIGGER IF EXISTS identifier_assignment_update_audit_before_insert ON public.identifier_assignment;
DROP TRIGGER IF EXISTS groups_update_audit_before_update ON public.groups;
DROP TRIGGER IF EXISTS groups_update_audit_before_insert ON public.groups;
DROP TRIGGER IF EXISTS group_subject_update_audit_before_update ON public.group_subject;
DROP TRIGGER IF EXISTS group_subject_update_audit_before_insert ON public.group_subject;
DROP TRIGGER IF EXISTS group_role_update_audit_before_update ON public.group_role;
DROP TRIGGER IF EXISTS group_role_update_audit_before_insert ON public.group_role;
DROP TRIGGER IF EXISTS group_privilege_update_audit_before_update ON public.group_privilege;
DROP TRIGGER IF EXISTS group_privilege_update_audit_before_insert ON public.group_privilege;
DROP TRIGGER IF EXISTS group_dashboard_update_audit_before_update ON public.group_dashboard;
DROP TRIGGER IF EXISTS group_dashboard_update_audit_before_insert ON public.group_dashboard;
DROP TRIGGER IF EXISTS gender_update_audit_before_update ON public.gender;
DROP TRIGGER IF EXISTS gender_update_audit_before_insert ON public.gender;
DROP TRIGGER IF EXISTS form_update_audit_before_update ON public.form;
DROP TRIGGER IF EXISTS form_update_audit_before_insert ON public.form;
DROP TRIGGER IF EXISTS form_mapping_update_audit_before_update ON public.form_mapping;
DROP TRIGGER IF EXISTS form_mapping_update_audit_before_insert ON public.form_mapping;
DROP TRIGGER IF EXISTS form_element_update_audit_before_update ON public.form_element;
DROP TRIGGER IF EXISTS form_element_update_audit_before_insert ON public.form_element;
DROP TRIGGER IF EXISTS form_element_group_update_audit_before_update ON public.form_element_group;
DROP TRIGGER IF EXISTS form_element_group_update_audit_before_insert ON public.form_element_group;
DROP TRIGGER IF EXISTS facility_update_audit_before_update ON public.facility;
DROP TRIGGER IF EXISTS facility_update_audit_before_insert ON public.facility;
DROP TRIGGER IF EXISTS entity_approval_status_update_audit_before_update ON public.entity_approval_status;
DROP TRIGGER IF EXISTS entity_approval_status_update_audit_before_insert ON public.entity_approval_status;
DROP TRIGGER IF EXISTS encounter_update_audit_before_update ON public.encounter;
DROP TRIGGER IF EXISTS encounter_update_audit_before_insert ON public.encounter;
DROP TRIGGER IF EXISTS encounter_type_update_audit_before_update ON public.encounter_type;
DROP TRIGGER IF EXISTS encounter_type_update_audit_before_insert ON public.encounter_type;
DROP TRIGGER IF EXISTS delete_on_virtual_catchment_address_mapping ON public.virtual_catchment_address_mapping_table;
DROP TRIGGER IF EXISTS dashboard_update_audit_before_update ON public.dashboard;
DROP TRIGGER IF EXISTS dashboard_update_audit_before_insert ON public.dashboard;
DROP TRIGGER IF EXISTS dashboard_section_update_audit_before_update ON public.dashboard_section;
DROP TRIGGER IF EXISTS dashboard_section_update_audit_before_insert ON public.dashboard_section;
DROP TRIGGER IF EXISTS dashboard_section_card_mapping_update_audit_before_update ON public.dashboard_section_card_mapping;
DROP TRIGGER IF EXISTS dashboard_section_card_mapping_update_audit_before_insert ON public.dashboard_section_card_mapping;
DROP TRIGGER IF EXISTS dashboard_card_mapping_update_audit_before_update ON public.dashboard_card_mapping;
DROP TRIGGER IF EXISTS dashboard_card_mapping_update_audit_before_insert ON public.dashboard_card_mapping;
DROP TRIGGER IF EXISTS concept_update_audit_before_update ON public.concept;
DROP TRIGGER IF EXISTS concept_update_audit_before_insert ON public.concept;
DROP TRIGGER IF EXISTS concept_answer_update_audit_before_update ON public.concept_answer;
DROP TRIGGER IF EXISTS concept_answer_update_audit_before_insert ON public.concept_answer;
DROP TRIGGER IF EXISTS comment_update_audit_before_update ON public.comment;
DROP TRIGGER IF EXISTS comment_update_audit_before_insert ON public.comment;
DROP TRIGGER IF EXISTS comment_thread_update_audit_before_update ON public.comment_thread;
DROP TRIGGER IF EXISTS comment_thread_update_audit_before_insert ON public.comment_thread;
DROP TRIGGER IF EXISTS checklist_update_audit_before_update ON public.checklist;
DROP TRIGGER IF EXISTS checklist_update_audit_before_insert ON public.checklist;
DROP TRIGGER IF EXISTS checklist_item_update_audit_before_update ON public.checklist_item;
DROP TRIGGER IF EXISTS checklist_item_update_audit_before_insert ON public.checklist_item;
DROP TRIGGER IF EXISTS checklist_item_detail_update_audit_before_update ON public.checklist_item_detail;
DROP TRIGGER IF EXISTS checklist_item_detail_update_audit_before_insert ON public.checklist_item_detail;
DROP TRIGGER IF EXISTS checklist_detail_update_audit_before_update ON public.checklist_detail;
DROP TRIGGER IF EXISTS checklist_detail_update_audit_before_insert ON public.checklist_detail;
DROP TRIGGER IF EXISTS catchment_update_audit_before_update ON public.catchment;
DROP TRIGGER IF EXISTS catchment_update_audit_before_insert ON public.catchment;
DROP TRIGGER IF EXISTS address_level_update_audit_before_update ON public.address_level;
DROP TRIGGER IF EXISTS address_level_update_audit_before_insert ON public.address_level;
DROP TRIGGER IF EXISTS address_level_type_update_audit_before_update ON public.address_level_type;
DROP TRIGGER IF EXISTS address_level_type_update_audit_before_insert ON public.address_level_type;
DROP INDEX IF EXISTS public.video_telemetric_organisation_id__index;
DROP INDEX IF EXISTS public.video_organisation_id__index;
DROP INDEX IF EXISTS public.video_last_modified_time_idx;
DROP INDEX IF EXISTS public.users_username_idx;
DROP INDEX IF EXISTS public.users_organisation_id__index;
DROP INDEX IF EXISTS public.user_subject_assignment_user_id_index;
DROP INDEX IF EXISTS public.user_subject_assignment_subject_id_index;
DROP INDEX IF EXISTS public.user_group_last_modified_time_idx;
DROP INDEX IF EXISTS public.user_group_group_id_index;
DROP INDEX IF EXISTS public.translation_last_modified_time_idx;
DROP INDEX IF EXISTS public.task_observations_idx;
DROP INDEX IF EXISTS public.task_metadata_idx;
DROP INDEX IF EXISTS public.table_metadata_table_id_idx;
DROP INDEX IF EXISTS public.sync_telemetry_user_id_idx;
DROP INDEX IF EXISTS public.sync_telemetry_sync_start_time_idx;
DROP INDEX IF EXISTS public.sync_telemetry_organisation_id__index;
DROP INDEX IF EXISTS public.sync_telemetry_last_modified_time_idx;
DROP INDEX IF EXISTS public.subject_type_organisation_id__index;
DROP INDEX IF EXISTS public.subject_type_last_modified_time_idx;
DROP INDEX IF EXISTS public.subject_migration_sync_fields_2_idx;
DROP INDEX IF EXISTS public.subject_migration_sync_fields_1_idx;
DROP INDEX IF EXISTS public.subject_migration_last_modified_time_idx;
DROP INDEX IF EXISTS public.rule_organisation_id__index;
DROP INDEX IF EXISTS public.rule_last_modified_time_idx;
DROP INDEX IF EXISTS public.rule_failure_telemetry_last_modified_time_idx;
DROP INDEX IF EXISTS public.rule_failure_log_last_modified_time_idx;
DROP INDEX IF EXISTS public.rule_dependency_organisation_id__index;
DROP INDEX IF EXISTS public.rule_dependency_last_modified_time_idx;
DROP INDEX IF EXISTS public.reset_sync_user_id_index;
DROP INDEX IF EXISTS public.reset_sync_subject_type_id_index;
DROP INDEX IF EXISTS public.report_card_last_modified_time_idx;
DROP INDEX IF EXISTS public.program_outcome_organisation_id__index;
DROP INDEX IF EXISTS public.program_outcome_last_modified_time_idx;
DROP INDEX IF EXISTS public.program_organisation_id__index;
DROP INDEX IF EXISTS public.program_last_modified_time_idx;
DROP INDEX IF EXISTS public.program_enrolment_program_id_index;
DROP INDEX IF EXISTS public.program_enrolment_organisation_id__index;
DROP INDEX IF EXISTS public.program_enrolment_obs_idx;
DROP INDEX IF EXISTS public.program_enrolment_legacy_id_index;
DROP INDEX IF EXISTS public.program_enrolment_last_modified_time_idx;
DROP INDEX IF EXISTS public.program_enrolment_individual_id_index;
DROP INDEX IF EXISTS public.program_enrolment_exit_obs_idx;
DROP INDEX IF EXISTS public.program_encounter_program_enrolment_id_index;
DROP INDEX IF EXISTS public.program_encounter_organisation_id__index;
DROP INDEX IF EXISTS public.program_encounter_obs_idx;
DROP INDEX IF EXISTS public.program_encounter_legacy_id_index;
DROP INDEX IF EXISTS public.program_encounter_last_modified_time_idx;
DROP INDEX IF EXISTS public.program_encounter_encounter_type_id_index;
DROP INDEX IF EXISTS public.program_encounter_cancel_obs_idx;
DROP INDEX IF EXISTS public.post_etl_sync_status_db_user_idx;
DROP INDEX IF EXISTS public.platform_translation_last_modified_time_idx;
DROP INDEX IF EXISTS public.organisation_config_last_modified_time_idx;
DROP INDEX IF EXISTS public.operational_subject_type_subject_type_id_index;
DROP INDEX IF EXISTS public.operational_subject_type_organisation_id__index;
DROP INDEX IF EXISTS public.operational_subject_type_last_modified_time_idx;
DROP INDEX IF EXISTS public.operational_program_program_id_index;
DROP INDEX IF EXISTS public.operational_program_organisation_id__index;
DROP INDEX IF EXISTS public.operational_program_last_modified_time_idx;
DROP INDEX IF EXISTS public.operational_encounter_type_organisation_id__index;
DROP INDEX IF EXISTS public.operational_encounter_type_last_modified_time_idx;
DROP INDEX IF EXISTS public.operational_encounter_type_encounter_type_id_index;
DROP INDEX IF EXISTS public.non_applicable_form_element_organisation_id__index;
DROP INDEX IF EXISTS public.non_applicable_form_element_last_modified_time_idx;
DROP INDEX IF EXISTS public.non_applicable_form_element_form_element_id_index;
DROP INDEX IF EXISTS public.news_uuid_organisation_id_uniq_idx;
DROP INDEX IF EXISTS public.news_published_date_idx;
DROP INDEX IF EXISTS public.news_last_modified_time_idx;
DROP INDEX IF EXISTS public.msg91_config_last_modified_time_idx;
DROP INDEX IF EXISTS public.location_location_mapping_organisation_id__index;
DROP INDEX IF EXISTS public.location_location_mapping_last_modified_time_idx;
DROP INDEX IF EXISTS public.individual_subject_type_id_index;
DROP INDEX IF EXISTS public.individual_relative_relative_individual_id_index;
DROP INDEX IF EXISTS public.individual_relative_organisation_id__index;
DROP INDEX IF EXISTS public.individual_relative_last_modified_time_idx;
DROP INDEX IF EXISTS public.individual_relative_individual_id_index;
DROP INDEX IF EXISTS public.individual_relationship_type_organisation_id__index;
DROP INDEX IF EXISTS public.individual_relationship_type_last_modified_time_idx;
DROP INDEX IF EXISTS public.individual_relationship_type_individual_b_is_to_a_relation_id_i;
DROP INDEX IF EXISTS public.individual_relationship_type_individual_a_is_to_b_relation_id_i;
DROP INDEX IF EXISTS public.individual_relationship_relationship_type_id_index;
DROP INDEX IF EXISTS public.individual_relationship_organisation_id__index;
DROP INDEX IF EXISTS public.individual_relationship_last_modified_time_idx;
DROP INDEX IF EXISTS public.individual_relationship_individual_b_id_index;
DROP INDEX IF EXISTS public.individual_relationship_individual_a_id_index;
DROP INDEX IF EXISTS public.individual_relation_organisation_id__index;
DROP INDEX IF EXISTS public.individual_relation_last_modified_time_idx;
DROP INDEX IF EXISTS public.individual_relation_gender_mapping_relation_id_index;
DROP INDEX IF EXISTS public.individual_relation_gender_mapping_organisation_id__index;
DROP INDEX IF EXISTS public.individual_relation_gender_mapping_last_modified_time_idx;
DROP INDEX IF EXISTS public.individual_organisation_id__index;
DROP INDEX IF EXISTS public.individual_legacy_id_index;
DROP INDEX IF EXISTS public.individual_last_modified_time_idx;
DROP INDEX IF EXISTS public.idx_scheduled_job_run_job_name;
...
DROP INDEX IF EXISTS public.idx_program_enrolment_obs;
DROP INDEX IF EXISTS public.idx_program_encounter_obs;
DROP INDEX IF EXISTS public.idx_individual_obs;
DROP INDEX IF EXISTS public.identifier_user_assignment_organisation_id__index;
DROP INDEX IF EXISTS public.identifier_user_assignment_last_modified_time_idx;
DROP INDEX IF EXISTS public.identifier_user_assignment_identifier_source_id_index;
DROP INDEX IF EXISTS public.identifier_source_organisation_id__index;
DROP INDEX IF EXISTS public.identifier_source_last_modified_time_idx;
DROP INDEX IF EXISTS public.identifier_assignment_program_enrolment_id_index;
DROP INDEX IF EXISTS public.identifier_assignment_organisation_id__index;
DROP INDEX IF EXISTS public.identifier_assignment_last_modified_time_idx;
DROP INDEX IF EXISTS public.identifier_assignment_individual_id_index;
DROP INDEX IF EXISTS public.identifier_assignment_identifier_source_id_index;
DROP INDEX IF EXISTS public.groups_last_modified_time_idx;
DROP INDEX IF EXISTS public.group_subject_member_subject_id_index;
DROP INDEX IF EXISTS public.group_subject_last_modified_time_idx;
DROP INDEX IF EXISTS public.group_subject_group_subject_id_index;
DROP INDEX IF EXISTS public.group_subject_group_role_id_index;
DROP INDEX IF EXISTS public.group_role_member_subject_type_id_index;
DROP INDEX IF EXISTS public.group_role_last_modified_time_idx;
DROP INDEX IF EXISTS public.group_role_group_subject_type_id_index;
DROP INDEX IF EXISTS public.group_privilege_subject_type_id_index;
DROP INDEX IF EXISTS public.group_privilege_program_id_index;
DROP INDEX IF EXISTS public.group_privilege_program_encounter_type_id_index;
DROP INDEX IF EXISTS public.group_privilege_last_modified_time_idx;
DROP INDEX IF EXISTS public.group_privilege_group_id_index;
DROP INDEX IF EXISTS public.group_privilege_encounter_type_id_index;
DROP INDEX IF EXISTS public.group_privilege_checklist_detail_id_index;
DROP INDEX IF EXISTS public.group_dashboard_last_modified_time_idx;
DROP INDEX IF EXISTS public.gender_organisation_id__index;
DROP INDEX IF EXISTS public.gender_last_modified_time_idx;
DROP INDEX IF EXISTS public.gender_concept_id_index;
DROP INDEX IF EXISTS public.form_organisation_id__index;
DROP INDEX IF EXISTS public.form_mapping_subject_type_id_index;
DROP INDEX IF EXISTS public.form_mapping_organisation_id__index;
DROP INDEX IF EXISTS public.form_mapping_last_modified_time_idx;
DROP INDEX IF EXISTS public.form_mapping_form_id_index;
DROP INDEX IF EXISTS public.form_last_modified_time_idx;
DROP INDEX IF EXISTS public.form_element_organisation_id__index;
DROP INDEX IF EXISTS public.form_element_last_modified_time_idx;
DROP INDEX IF EXISTS public.form_element_group_organisation_id__index;
DROP INDEX IF EXISTS public.form_element_group_last_modified_time_idx;
DROP INDEX IF EXISTS public.form_element_group_form_id_index;
DROP INDEX IF EXISTS public.form_element_form_element_group_id_index;
DROP INDEX IF EXISTS public.form_element_concept_id_index;
DROP INDEX IF EXISTS public.flyway_schema_history_s_idx;
DROP INDEX IF EXISTS public.facility_organisation_id__index;
DROP INDEX IF EXISTS public.facility_last_modified_time_idx;
DROP INDEX IF EXISTS public.entity_approval_status_sync_5_index;
DROP INDEX IF EXISTS public.entity_approval_status_sync_4_index;
DROP INDEX IF EXISTS public.entity_approval_status_sync_3_index;
DROP INDEX IF EXISTS public.entity_approval_status_sync_2_index;
DROP INDEX IF EXISTS public.entity_approval_status_sync_1_index;
DROP INDEX IF EXISTS public.entity_approval_status_last_modified_time_idx;
DROP INDEX IF EXISTS public.entity_approval_status_entity_type_index;
DROP INDEX IF EXISTS public.entity_approval_status_entity_id_index;
DROP INDEX IF EXISTS public.entity_approval_status_approval_status_id_index;
DROP INDEX IF EXISTS public.encounter_type_organisation_id__index;
DROP INDEX IF EXISTS public.encounter_type_last_modified_time_idx;
DROP INDEX IF EXISTS public.encounter_type_concept_id_index;
DROP INDEX IF EXISTS public.encounter_organisation_id__index;
DROP INDEX IF EXISTS public.encounter_obs_idx;
DROP INDEX IF EXISTS public.encounter_legacy_id_index;
DROP INDEX IF EXISTS public.encounter_last_modified_time_idx;
DROP INDEX IF EXISTS public.encounter_individual_id_index;
DROP INDEX IF EXISTS public.encounter_encounter_type_id_index;
DROP INDEX IF EXISTS public.encounter_cancel_obs_idx;
DROP INDEX IF EXISTS public.documentation_organisation_id_index;
DROP INDEX IF EXISTS public.documentation_item_organisation_id_index;
DROP INDEX IF EXISTS public.documentation_item_documentation_id_index;
DROP INDEX IF EXISTS public.dashboard_section_last_modified_time_idx;
DROP INDEX IF EXISTS public.dashboard_section_card_mapping_last_modified_time_idx;
DROP INDEX IF EXISTS public.dashboard_last_modified_time_idx;
DROP INDEX IF EXISTS public.dashboard_card_mapping_last_modified_time_idx;
DROP INDEX IF EXISTS public.concept_organisation_id__index;
DROP INDEX IF EXISTS public.concept_last_modified_time_idx;
DROP INDEX IF EXISTS public.concept_answer_organisation_id__index;
DROP INDEX IF EXISTS public.concept_answer_last_modified_time_idx;
DROP INDEX IF EXISTS public.concept_answer_concept_id_index;
DROP INDEX IF EXISTS public.concept_answer_answer_concept_id_index;
DROP INDEX IF EXISTS public.comment_uuid_organisation_id_uniq_idx;
DROP INDEX IF EXISTS public.comment_thread_uuid_organisation_id_uniq_idx;
DROP INDEX IF EXISTS public.comment_thread_last_modified_time_idx;
DROP INDEX IF EXISTS public.comment_subject_id_index;
DROP INDEX IF EXISTS public.comment_last_modified_time_idx;
DROP INDEX IF EXISTS public.checklist_program_enrolment_id_index;
DROP INDEX IF EXISTS public.checklist_organisation_id__index;
DROP INDEX IF EXISTS public.checklist_last_modified_time_idx;
DROP INDEX IF EXISTS public.checklist_item_organisation_id__index;
DROP INDEX IF EXISTS public.checklist_item_obs_idx;
DROP INDEX IF EXISTS public.checklist_item_last_modified_time_idx;
DROP INDEX IF EXISTS public.checklist_item_detail_organisation_id__index;
DROP INDEX IF EXISTS public.checklist_item_detail_last_modified_time_idx;
DROP INDEX IF EXISTS public.checklist_item_detail_form_id_index;
DROP INDEX IF EXISTS public.checklist_item_detail_dependent_on_index;
DROP INDEX IF EXISTS public.checklist_item_detail_concept_id_index;
DROP INDEX IF EXISTS public.checklist_item_detail_checklist_detail_id_index;
DROP INDEX IF EXISTS public.checklist_item_checklist_item_detail_id_index;
DROP INDEX IF EXISTS public.checklist_item_checklist_id_index;
DROP INDEX IF EXISTS public.checklist_detail_organisation_id__index;
DROP INDEX IF EXISTS public.checklist_detail_last_modified_time_idx;
DROP INDEX IF EXISTS public.checklist_checklist_detail_id_index;
DROP INDEX IF EXISTS public.catchment_organisation_id__index;
DROP INDEX IF EXISTS public.catchment_last_modified_time_idx;
DROP INDEX IF EXISTS public.address_level_type_organisation_id__index;
DROP INDEX IF EXISTS public.address_level_type_last_modified_time_idx;
DROP INDEX IF EXISTS public.address_level_organisation_id__index;
DROP INDEX IF EXISTS public.address_level_last_modified_time_idx;
ALTER TABLE IF EXISTS ONLY public.video DROP CONSTRAINT IF EXISTS video_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.video_telemetric DROP CONSTRAINT IF EXISTS video_telemetric_pkey;
...
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_uuid_key;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_user_id_key;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_subject_id_key;
ALTER TABLE IF EXISTS ONLY public.user_subject DROP CONSTRAINT IF EXISTS user_subject_pkey;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_subject_id_user_id_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.user_subject_assignment DROP CONSTRAINT IF EXISTS user_subject_assignment_pkey;
ALTER TABLE IF EXISTS ONLY public.user_group DROP CONSTRAINT IF EXISTS user_group_uuid_key;
ALTER TABLE IF EXISTS ONLY public.user_group DROP CONSTRAINT IF EXISTS user_group_pkey;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS unique_rule_name;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS unique_name_per_level;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS unique_fn_rule_name;
ALTER TABLE IF EXISTS ONLY public.translation DROP CONSTRAINT IF EXISTS translation_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.translation DROP CONSTRAINT IF EXISTS translation_pkey;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_uuid_uniq;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_pkey;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_organisation_id_uniq;
ALTER TABLE IF EXISTS ONLY public.template_organisation DROP CONSTRAINT IF EXISTS template_organisation_name_uniq;
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_uuid_key;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_uuid_key;
ALTER TABLE IF EXISTS ONLY public.task_unassignment DROP CONSTRAINT IF EXISTS task_unassignment_pkey;
ALTER TABLE IF EXISTS ONLY public.task_type DROP CONSTRAINT IF EXISTS task_type_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.task_type DROP CONSTRAINT IF EXISTS task_type_pkey;
ALTER TABLE IF EXISTS ONLY public.task_status DROP CONSTRAINT IF EXISTS task_status_uuid_organisation_id_key;
...
ALTER TABLE IF EXISTS ONLY public.task DROP CONSTRAINT IF EXISTS task_legacy_id_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.table_metadata DROP CONSTRAINT IF EXISTS table_metadata_pkey;
ALTER TABLE IF EXISTS ONLY public.sync_telemetry DROP CONSTRAINT IF EXISTS sync_telemetry_pkey;
ALTER TABLE IF EXISTS ONLY public.subject_type DROP CONSTRAINT IF EXISTS subject_type_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.subject_type DROP CONSTRAINT IF EXISTS subject_type_pkey;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_uuid_key;
ALTER TABLE IF EXISTS ONLY public.subject_program_eligibility DROP CONSTRAINT IF EXISTS subject_program_eligibility_pkey;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.subject_migration DROP CONSTRAINT IF EXISTS subject_migration_pkey;
ALTER TABLE IF EXISTS ONLY public.standard_report_card_type DROP CONSTRAINT IF EXISTS standard_report_card_type_pkey;
ALTER TABLE IF EXISTS ONLY public.scheduled_job_run DROP CONSTRAINT IF EXISTS scheduled_job_run_pkey;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS rule_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.rule DROP CONSTRAINT IF EXISTS rule_pkey;
ALTER TABLE IF EXISTS ONLY public.rule_failure_telemetry DROP CONSTRAINT IF EXISTS rule_failure_telemetry_pkey;
ALTER TABLE IF EXISTS ONLY public.rule_failure_log DROP CONSTRAINT IF EXISTS rule_failure_log_uuid_key;
ALTER TABLE IF EXISTS ONLY public.rule_failure_log DROP CONSTRAINT IF EXISTS rule_failure_log_pkey;
ALTER TABLE IF EXISTS ONLY public.rule_dependency DROP CONSTRAINT IF EXISTS rule_dependency_uuid_key;
ALTER TABLE IF EXISTS ONLY public.rule_dependency DROP CONSTRAINT IF EXISTS rule_dependency_pkey;
ALTER TABLE IF EXISTS ONLY public.reset_sync DROP CONSTRAINT IF EXISTS reset_sync_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.reset_sync DROP CONSTRAINT IF EXISTS reset_sync_pkey;
ALTER TABLE IF EXISTS ONLY public.report_card DROP CONSTRAINT IF EXISTS report_card_name_unique;
...
ALTER TABLE IF EXISTS ONLY public.program DROP CONSTRAINT IF EXISTS program_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.program DROP CONSTRAINT IF EXISTS program_pkey;
ALTER TABLE IF EXISTS ONLY public.program_outcome DROP CONSTRAINT IF EXISTS program_outcome_uuid_key;
ALTER TABLE IF EXISTS ONLY public.program_outcome DROP CONSTRAINT IF EXISTS program_outcome_pkey;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_uuid_key;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_pkey;
ALTER TABLE IF EXISTS ONLY public.program_enrolment DROP CONSTRAINT IF EXISTS program_enrolment_legacy_id_organisation_id_uniq_idx;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_uuid_key;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_pkey;
ALTER TABLE IF EXISTS ONLY public.program_encounter DROP CONSTRAINT IF EXISTS program_encounter_legacy_id_organisation_id_uniq_idx;
ALTER TABLE IF EXISTS ONLY public.privilege DROP CONSTRAINT IF EXISTS privilege_pkey;
ALTER TABLE IF EXISTS ONLY public.post_etl_sync_status DROP CONSTRAINT IF EXISTS post_etl_sync_status_pkey;
ALTER TABLE IF EXISTS ONLY public.post_etl_sync_status DROP CONSTRAINT IF EXISTS post_etl_sync_status_db_user_key;
ALTER TABLE IF EXISTS ONLY public.platform_translation DROP CONSTRAINT IF EXISTS platform_translation_pkey;
ALTER TABLE IF EXISTS ONLY public.organisation DROP CONSTRAINT IF EXISTS organisation_uuid_key;
ALTER TABLE IF EXISTS ONLY public.organisation_status DROP CONSTRAINT IF EXISTS organisation_status_pkey;
...
ALTER TABLE IF EXISTS ONLY public.organisation DROP CONSTRAINT IF EXISTS organisation_media_directory_key;
ALTER TABLE IF EXISTS ONLY public.organisation_group DROP CONSTRAINT IF EXISTS organisation_group_pkey;
ALTER TABLE IF EXISTS ONLY public.organisation_group_organisation DROP CONSTRAINT IF EXISTS organisation_group_organisation_pkey;
ALTER TABLE IF EXISTS ONLY public.organisation DROP CONSTRAINT IF EXISTS organisation_db_user_key;
ALTER TABLE IF EXISTS ONLY public.organisation_config DROP CONSTRAINT IF EXISTS organisation_config_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.organisation_config DROP CONSTRAINT IF EXISTS organisation_config_pkey;
ALTER TABLE IF EXISTS ONLY public.organisation_config DROP CONSTRAINT IF EXISTS organisation_config_organisation_id_is_voided_key;
ALTER TABLE IF EXISTS ONLY public.organisation_category DROP CONSTRAINT IF EXISTS organisation_category_pkey;
ALTER TABLE IF EXISTS ONLY public.operational_subject_type DROP CONSTRAINT IF EXISTS operational_subject_type_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.operational_subject_type DROP CONSTRAINT IF EXISTS operational_subject_type_pkey;
ALTER TABLE IF EXISTS ONLY public.operational_program DROP CONSTRAINT IF EXISTS operational_program_program_id_organisation_id_unique;
ALTER TABLE IF EXISTS ONLY public.operational_program DROP CONSTRAINT IF EXISTS operational_program_pkey;
ALTER TABLE IF EXISTS ONLY public.operational_encounter_type DROP CONSTRAINT IF EXISTS operational_encounter_type_pkey;
ALTER TABLE IF EXISTS ONLY public.operational_encounter_type DROP CONSTRAINT IF EXISTS operational_encounter_type_encounter_type_organisation_id_uniqu;
ALTER TABLE IF EXISTS ONLY public.non_applicable_form_element DROP CONSTRAINT IF EXISTS non_applicable_form_element_pkey;
ALTER TABLE IF EXISTS ONLY public.news DROP CONSTRAINT IF EXISTS news_uuid_key;
ALTER TABLE IF EXISTS ONLY public.news DROP CONSTRAINT IF EXISTS news_pkey;
ALTER TABLE IF EXISTS ONLY public.msg91_config DROP CONSTRAINT IF EXISTS msg91_config_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.msg91_config DROP CONSTRAINT IF EXISTS msg91_config_pkey;
ALTER TABLE IF EXISTS ONLY public.message_rule DROP CONSTRAINT IF EXISTS message_rule_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.message_rule DROP CONSTRAINT IF EXISTS message_rule_pkey;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.message_request_queue DROP CONSTRAINT IF EXISTS message_request_queue_pkey;
ALTER TABLE IF EXISTS ONLY public.message_receiver DROP CONSTRAINT IF EXISTS message_receiver_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.message_receiver DROP CONSTRAINT IF EXISTS message_receiver_receiver_id_receiver_type_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.message_receiver DROP CONSTRAINT IF EXISTS message_receiver_pkey;
ALTER TABLE IF EXISTS ONLY public.menu_item DROP CONSTRAINT IF EXISTS menu_item_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.menu_item DROP CONSTRAINT IF EXISTS menu_item_pkey;
ALTER TABLE IF EXISTS ONLY public.manual_message DROP CONSTRAINT IF EXISTS manual_broadcast_message_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.manual_message DROP CONSTRAINT IF EXISTS manual_broadcast_message_pkey;
ALTER TABLE IF EXISTS ONLY public.location_location_mapping DROP CONSTRAINT IF EXISTS location_location_mapping_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.location_location_mapping DROP CONSTRAINT IF EXISTS location_location_mapping_pkey;
ALTER TABLE IF EXISTS ONLY public.batch_job_instance DROP CONSTRAINT IF EXISTS job_inst_un;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_uuid_key;
ALTER TABLE IF EXISTS ONLY public.individual_relative DROP CONSTRAINT IF EXISTS individual_relative_pkey;
ALTER TABLE IF EXISTS ONLY public.individual_relationship DROP CONSTRAINT IF EXISTS individual_relationship_uuid_key;
ALTER TABLE IF EXISTS ONLY public.individual_relationship_type DROP CONSTRAINT IF EXISTS individual_relationship_type_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.individual_relationship_type DROP CONSTRAINT IF EXISTS individual_relationship_type_pkey;
ALTER TABLE IF EXISTS ONLY public.individual_relationship DROP CONSTRAINT IF EXISTS individual_relationship_pkey;
ALTER TABLE IF EXISTS ONLY public.individual_relation DROP CONSTRAINT IF EXISTS individual_relation_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.individual_relation DROP CONSTRAINT IF EXISTS individual_relation_pkey;
ALTER TABLE IF EXISTS ONLY public.individual_relation_gender_mapping DROP CONSTRAINT IF EXISTS individual_relation_gender_mapping_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.individual_relation_gender_mapping DROP CONSTRAINT IF EXISTS individual_relation_gender_mapping_pkey;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_pkey;
ALTER TABLE IF EXISTS ONLY public.individual DROP CONSTRAINT IF EXISTS individual_legacy_id_organisation_id_uniq_idx;
ALTER TABLE IF EXISTS ONLY public.index_metadata DROP CONSTRAINT IF EXISTS index_metadata_pkey;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_pkey;
ALTER TABLE IF EXISTS ONLY public.identifier_user_assignment DROP CONSTRAINT IF EXISTS identifier_user_assignment_identifier_source_id_assigned_to_key;
ALTER TABLE IF EXISTS ONLY public.identifier_source DROP CONSTRAINT IF EXISTS identifier_source_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.identifier_source DROP CONSTRAINT IF EXISTS identifier_source_pkey;
ALTER TABLE IF EXISTS ONLY public.identifier_source DROP CONSTRAINT IF EXISTS identifier_source_name_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_uuid_key;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_pkey;
ALTER TABLE IF EXISTS ONLY public.identifier_assignment DROP CONSTRAINT IF EXISTS identifier_assignment_identifier_source_id_identifier_organ_key;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS groups_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS groups_pkey;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.group_subject DROP CONSTRAINT IF EXISTS group_subject_pkey;
ALTER TABLE IF EXISTS ONLY public.group_role DROP CONSTRAINT IF EXISTS group_role_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.group_role DROP CONSTRAINT IF EXISTS group_role_pkey;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.group_privilege DROP CONSTRAINT IF EXISTS group_privilege_pkey;
ALTER TABLE IF EXISTS ONLY public.group_dashboard DROP CONSTRAINT IF EXISTS group_dashboard_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.group_dashboard DROP CONSTRAINT IF EXISTS group_dashboard_pkey;
ALTER TABLE IF EXISTS ONLY public.gender DROP CONSTRAINT IF EXISTS gender_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.gender DROP CONSTRAINT IF EXISTS gender_pkey;
ALTER TABLE IF EXISTS ONLY public.form DROP CONSTRAINT IF EXISTS form_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.form DROP CONSTRAINT IF EXISTS form_pkey;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.form_mapping DROP CONSTRAINT IF EXISTS form_mapping_pkey;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS form_element_pkey;
ALTER TABLE IF EXISTS ONLY public.form_element_group DROP CONSTRAINT IF EXISTS form_element_group_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.form_element_group DROP CONSTRAINT IF EXISTS form_element_group_pkey;
ALTER TABLE IF EXISTS ONLY public.flyway_schema_history DROP CONSTRAINT IF EXISTS flyway_schema_history_pk;
ALTER TABLE IF EXISTS ONLY public.flow_request_queue DROP CONSTRAINT IF EXISTS flow_request_queue_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.flow_request_queue DROP CONSTRAINT IF EXISTS flow_request_queue_pkey;
ALTER TABLE IF EXISTS ONLY public.form_element_group DROP CONSTRAINT IF EXISTS feg_f_id_display_order_org_id_is_voided_key;
ALTER TABLE IF EXISTS ONLY public.form_element DROP CONSTRAINT IF EXISTS fe_feg_id_display_order_org_id_is_voided_key;
ALTER TABLE IF EXISTS ONLY public.facility DROP CONSTRAINT IF EXISTS facility_pkey;
ALTER TABLE IF EXISTS ONLY public.external_system_config DROP CONSTRAINT IF EXISTS external_system_config_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.external_system_config DROP CONSTRAINT IF EXISTS external_system_config_pkey;
ALTER TABLE IF EXISTS ONLY public.export_job_parameters DROP CONSTRAINT IF EXISTS export_job_parameters_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.export_job_parameters DROP CONSTRAINT IF EXISTS export_job_parameters_pkey;
ALTER TABLE IF EXISTS ONLY public.entity_sync_status DROP CONSTRAINT IF EXISTS entity_sync_status_pkey;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.entity_approval_status DROP CONSTRAINT IF EXISTS entity_approval_status_pkey;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_uuid_key;
ALTER TABLE IF EXISTS ONLY public.encounter_type DROP CONSTRAINT IF EXISTS encounter_type_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.encounter_type DROP CONSTRAINT IF EXISTS encounter_type_pkey;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_pkey;
ALTER TABLE IF EXISTS ONLY public.encounter DROP CONSTRAINT IF EXISTS encounter_legacy_id_organisation_id_uniq_idx;
ALTER TABLE IF EXISTS ONLY public.documentation DROP CONSTRAINT IF EXISTS documentation_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.documentation DROP CONSTRAINT IF EXISTS documentation_pkey;
ALTER TABLE IF EXISTS ONLY public.documentation_item DROP CONSTRAINT IF EXISTS documentation_item_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.documentation_item DROP CONSTRAINT IF EXISTS documentation_item_pkey;
ALTER TABLE IF EXISTS ONLY public.deps_saved_ddl DROP CONSTRAINT IF EXISTS deps_saved_ddl_pkey;
ALTER TABLE IF EXISTS ONLY public.decision_concept DROP CONSTRAINT IF EXISTS decision_concept_pkey;
ALTER TABLE IF EXISTS ONLY public.dashboard DROP CONSTRAINT IF EXISTS dashboard_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.dashboard_section DROP CONSTRAINT IF EXISTS dashboard_section_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.dashboard_section DROP CONSTRAINT IF EXISTS dashboard_section_pkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_section_card_mapping DROP CONSTRAINT IF EXISTS dashboard_section_card_mapping_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.dashboard_section_card_mapping DROP CONSTRAINT IF EXISTS dashboard_section_card_mapping_pkey;
ALTER TABLE IF EXISTS ONLY public.dashboard DROP CONSTRAINT IF EXISTS dashboard_pkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_filter DROP CONSTRAINT IF EXISTS dashboard_filter_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.dashboard_filter DROP CONSTRAINT IF EXISTS dashboard_filter_pkey;
ALTER TABLE IF EXISTS ONLY public.dashboard_card_mapping DROP CONSTRAINT IF EXISTS dashboard_card_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.dashboard_card_mapping DROP CONSTRAINT IF EXISTS dashboard_card_mapping_pkey;
ALTER TABLE IF EXISTS ONLY public.custom_query DROP CONSTRAINT IF EXISTS custom_query_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.custom_query DROP CONSTRAINT IF EXISTS custom_query_pkey;
ALTER TABLE IF EXISTS public.user_subject_assignment DROP CONSTRAINT IF EXISTS constraint_user_subject_assignment_sync_disabled_same_as_ind;
ALTER TABLE IF EXISTS public.subject_migration DROP CONSTRAINT IF EXISTS constraint_subject_migration_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.program_enrolment DROP CONSTRAINT IF EXISTS constraint_program_enrolment_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.program_encounter DROP CONSTRAINT IF EXISTS constraint_program_encounter_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.group_subject DROP CONSTRAINT IF EXISTS constraint_group_subject_status_sync_disabled_same_as_ind;
ALTER TABLE IF EXISTS public.entity_approval_status DROP CONSTRAINT IF EXISTS constraint_entity_approval_status_sync_disabled_same_as_ind;
ALTER TABLE IF EXISTS public.encounter DROP CONSTRAINT IF EXISTS constraint_encounter_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.comment_thread DROP CONSTRAINT IF EXISTS constraint_comment_thread_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.comment DROP CONSTRAINT IF EXISTS constraint_comment_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.checklist DROP CONSTRAINT IF EXISTS constraint_checklist_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.checklist_item DROP CONSTRAINT IF EXISTS constraint_checklist_item_sync_disabled_same_as_individual;
ALTER TABLE IF EXISTS public.subject_program_eligibility DROP CONSTRAINT IF EXISTS const_subject_program_eligibility_sync_disabled_same_as_ind;
ALTER TABLE IF EXISTS public.individual_relationship DROP CONSTRAINT IF EXISTS const_individual_relationship_sync_disabled_same_as_ind_a;
ALTER TABLE IF EXISTS ONLY public.concept DROP CONSTRAINT IF EXISTS concept_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.concept DROP CONSTRAINT IF EXISTS concept_pkey;
ALTER TABLE IF EXISTS ONLY public.concept DROP CONSTRAINT IF EXISTS concept_name_orgid;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_pkey;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_concept_id_answer_concept_id_organisation_id_uni;
ALTER TABLE IF EXISTS ONLY public.concept_answer DROP CONSTRAINT IF EXISTS concept_answer_concept_id_answer_concept_id_key;
ALTER TABLE IF EXISTS ONLY public.comment DROP CONSTRAINT IF EXISTS comment_uuid_key;
ALTER TABLE IF EXISTS ONLY public.comment_thread DROP CONSTRAINT IF EXISTS comment_thread_uuid_key;
ALTER TABLE IF EXISTS ONLY public.comment_thread DROP CONSTRAINT IF EXISTS comment_thread_pkey;
ALTER TABLE IF EXISTS ONLY public.comment DROP CONSTRAINT IF EXISTS comment_pkey;
ALTER TABLE IF EXISTS ONLY public.column_metadata DROP CONSTRAINT IF EXISTS column_metadata_pkey;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_uuid_key;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_pkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item DROP CONSTRAINT IF EXISTS checklist_item_uuid_key;
ALTER TABLE IF EXISTS ONLY public.checklist_item DROP CONSTRAINT IF EXISTS checklist_item_pkey;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.checklist_item_detail DROP CONSTRAINT IF EXISTS checklist_item_detail_pkey;
ALTER TABLE IF EXISTS ONLY public.checklist_detail DROP CONSTRAINT IF EXISTS checklist_detail_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.checklist_detail DROP CONSTRAINT IF EXISTS checklist_detail_pkey;
ALTER TABLE IF EXISTS ONLY public.checklist DROP CONSTRAINT IF EXISTS checklist_checklist_detail_id_program_enrolment_id_unique;
ALTER TABLE IF EXISTS ONLY public.catchment DROP CONSTRAINT IF EXISTS catchment_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.catchment DROP CONSTRAINT IF EXISTS catchment_pkey;
ALTER TABLE IF EXISTS ONLY public.catchment DROP CONSTRAINT IF EXISTS catchment_name_organisation_id_unique;
ALTER TABLE IF EXISTS ONLY public.catchment_address_mapping DROP CONSTRAINT IF EXISTS catchment_address_mapping_pkey;
ALTER TABLE IF EXISTS ONLY public.catchment_address_mapping DROP CONSTRAINT IF EXISTS catchment_address_mapping_catchment_id_address_level_id_unique;
ALTER TABLE IF EXISTS ONLY public.report_card DROP CONSTRAINT IF EXISTS card_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.report_card DROP CONSTRAINT IF EXISTS card_pkey;
...
ALTER TABLE IF EXISTS ONLY public.storage_management_config DROP CONSTRAINT IF EXISTS archival_config_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.storage_management_config DROP CONSTRAINT IF EXISTS archival_config_pkey;
ALTER TABLE IF EXISTS ONLY public.approval_status DROP CONSTRAINT IF EXISTS approval_status_pkey;
ALTER TABLE IF EXISTS ONLY public.answer_concept_migration DROP CONSTRAINT IF EXISTS answer_concept_migration_uuid_organisation_id_key;
ALTER TABLE IF EXISTS ONLY public.answer_concept_migration DROP CONSTRAINT IF EXISTS answer_concept_migration_pkey;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_uuid_org_id_key;
ALTER TABLE IF EXISTS ONLY public.address_level_type DROP CONSTRAINT IF EXISTS address_level_type_pkey;
ALTER TABLE IF EXISTS ONLY public.address_level_type DROP CONSTRAINT IF EXISTS address_level_type_name_organisation_id_unique;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_pkey;
ALTER TABLE IF EXISTS ONLY public.address_level DROP CONSTRAINT IF EXISTS address_level_legacy_id_organisation_id_uniq_idx;
ALTER TABLE IF EXISTS ONLY public.account DROP CONSTRAINT IF EXISTS account_pkey;
ALTER TABLE IF EXISTS ONLY public.account_admin DROP CONSTRAINT IF EXISTS account_admin_pkey;
ALTER TABLE IF EXISTS public.video_telemetric ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.video ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_subject_assignment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_subject ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.task_unassignment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.task_type ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.table_metadata ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.sync_telemetry ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subject_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subject_program_eligibility ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subject_migration ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.storage_management_config ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.standard_report_card_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.scheduled_job_run ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rule_failure_telemetry ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rule_failure_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rule_dependency ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rule ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.reset_sync ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.report_card ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.program_outcome ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.program_enrolment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.program_encounter ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.program ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.privilege ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.post_etl_sync_status ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.platform_translation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.organisation_status ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.organisation_group_organisation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.organisation_group ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.organisation_config ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.organisation_category ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.organisation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.operational_subject_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.operational_program ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.operational_encounter_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.non_applicable_form_element ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.news ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.msg91_config ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.message_rule ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.message_request_queue ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.message_receiver ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.menu_item ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.manual_message ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.location_location_mapping ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.individual_relative ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.individual_relationship_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.individual_relationship ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.individual_relation_gender_mapping ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.individual_relation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.individual ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.index_metadata ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.identifier_user_assignment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.identifier_source ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.identifier_assignment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.groups ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.group_subject ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.group_role ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.group_privilege ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.group_dashboard ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.gender ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.form_mapping ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.form_element_group ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.form_element ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.form ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.flow_request_queue ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.facility ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.external_system_config ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.export_job_parameters ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.entity_sync_status ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.entity_approval_status ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.encounter_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.encounter ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.documentation_item ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.documentation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.deps_saved_ddl ALTER COLUMN deps_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.decision_concept ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.dashboard_section_card_mapping ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.dashboard_section ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.dashboard_filter ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.dashboard_card_mapping ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.dashboard ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.custom_query ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.concept_answer ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.concept ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.comment_thread ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.comment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.column_metadata ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.checklist_item_detail ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.checklist_item ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.checklist_detail ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.checklist ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.catchment_address_mapping ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.catchment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.audit ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.approval_status ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.answer_concept_migration ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.address_level_type ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.address_level ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.account_admin ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.account ALTER COLUMN id DROP DEFAULT;
DROP VIEW IF EXISTS public.virtual_catchment_address_mapping_table;
DROP SEQUENCE IF EXISTS public.video_telemetric_id_seq;
DROP TABLE IF EXISTS public.video_telemetric;
DROP SEQUENCE IF EXISTS public.video_id_seq;
DROP TABLE IF EXISTS public.video;
DROP SEQUENCE IF EXISTS public.users_id_seq;
DROP TABLE IF EXISTS public.users;
DROP SEQUENCE IF EXISTS public.user_subject_id_seq;
DROP SEQUENCE IF EXISTS public.user_subject_assignment_id_seq;
DROP TABLE IF EXISTS public.user_subject_assignment;
...
DROP VIEW IF EXISTS public.title_lineage_locations_view;
DROP TABLE IF EXISTS public.template_organisation;
DROP SEQUENCE IF EXISTS public.task_unassignment_id_seq;
DROP TABLE IF EXISTS public.task_unassignment;
...
DROP SEQUENCE IF EXISTS public.table_metadata_id_seq;
DROP TABLE IF EXISTS public.table_metadata;
DROP SEQUENCE IF EXISTS public.sync_telemetry_id_seq;
DROP TABLE IF EXISTS public.sync_telemetry;
DROP SEQUENCE IF EXISTS public.subject_type_id_seq;
DROP TABLE IF EXISTS public.subject_type;
DROP SEQUENCE IF EXISTS public.subject_program_eligibility_id_seq;
DROP TABLE IF EXISTS public.subject_program_eligibility;
DROP SEQUENCE IF EXISTS public.subject_migration_id_seq;
DROP TABLE IF EXISTS public.subject_migration;
DROP SEQUENCE IF EXISTS public.standard_report_card_type_id_seq;
DROP TABLE IF EXISTS public.standard_report_card_type;
DROP SEQUENCE IF EXISTS public.scheduled_job_run_id_seq;
DROP TABLE IF EXISTS public.scheduled_job_run;
DROP SEQUENCE IF EXISTS public.rule_id_seq;
DROP SEQUENCE IF EXISTS public.rule_failure_telemetry_id_seq;
DROP TABLE IF EXISTS public.rule_failure_telemetry;
DROP SEQUENCE IF EXISTS public.rule_failure_log_id_seq;
DROP TABLE IF EXISTS public.rule_failure_log;
DROP SEQUENCE IF EXISTS public.rule_dependency_id_seq;
DROP TABLE IF EXISTS public.rule_dependency;
DROP TABLE IF EXISTS public.rule;
DROP SEQUENCE IF EXISTS public.reset_sync_id_seq;
DROP TABLE IF EXISTS public.reset_sync;
DROP SEQUENCE IF EXISTS public.report_card_id_seq;
...
DROP SEQUENCE IF EXISTS public.program_outcome_id_seq;
DROP TABLE IF EXISTS public.program_outcome;
DROP SEQUENCE IF EXISTS public.program_id_seq;
DROP SEQUENCE IF EXISTS public.program_enrolment_id_seq;
DROP SEQUENCE IF EXISTS public.program_encounter_id_seq;
DROP TABLE IF EXISTS public.program_encounter;
DROP SEQUENCE IF EXISTS public.privilege_id_seq;
DROP TABLE IF EXISTS public.privilege;
DROP SEQUENCE IF EXISTS public.post_etl_sync_status_id_seq;
DROP TABLE IF EXISTS public.post_etl_sync_status;
DROP SEQUENCE IF EXISTS public.platform_translation_id_seq;
DROP TABLE IF EXISTS public.platform_translation;
DROP SEQUENCE IF EXISTS public.organisation_status_id_seq;
DROP TABLE IF EXISTS public.organisation_status;
DROP SEQUENCE IF EXISTS public.organisation_id_seq;
DROP SEQUENCE IF EXISTS public.organisation_group_organisation_id_seq;
DROP TABLE IF EXISTS public.organisation_group_organisation;
DROP SEQUENCE IF EXISTS public.organisation_group_id_seq;
DROP TABLE IF EXISTS public.organisation_group;
DROP SEQUENCE IF EXISTS public.organisation_config_id_seq;
DROP TABLE IF EXISTS public.organisation_config;
DROP SEQUENCE IF EXISTS public.organisation_category_id_seq;
DROP TABLE IF EXISTS public.organisation_category;
DROP VIEW IF EXISTS public.org_ids;
DROP SEQUENCE IF EXISTS public.operational_subject_type_id_seq;
DROP TABLE IF EXISTS public.operational_subject_type;
DROP SEQUENCE IF EXISTS public.operational_program_id_seq;
DROP SEQUENCE IF EXISTS public.operational_encounter_type_id_seq;
DROP SEQUENCE IF EXISTS public.non_applicable_form_element_id_seq;
DROP TABLE IF EXISTS public.non_applicable_form_element;
DROP SEQUENCE IF EXISTS public.news_id_seq;
DROP TABLE IF EXISTS public.news;
DROP SEQUENCE IF EXISTS public.msg91_config_id_seq;
DROP TABLE IF EXISTS public.msg91_config;
DROP SEQUENCE IF EXISTS public.message_rule_id_seq;
DROP TABLE IF EXISTS public.message_rule;
DROP SEQUENCE IF EXISTS public.message_request_queue_id_seq;
DROP TABLE IF EXISTS public.message_request_queue;
DROP SEQUENCE IF EXISTS public.message_receiver_id_seq;
...
DROP SEQUENCE IF EXISTS public.manual_message_id_seq;
DROP TABLE IF EXISTS public.manual_message;
DROP SEQUENCE IF EXISTS public.location_location_mapping_id_seq;
DROP TABLE IF EXISTS public.location_location_mapping;
DROP SEQUENCE IF EXISTS public.individual_relative_id_seq;
DROP TABLE IF EXISTS public.individual_relative;
DROP SEQUENCE IF EXISTS public.individual_relationship_type_id_seq;
DROP TABLE IF EXISTS public.individual_relationship_type;
DROP SEQUENCE IF EXISTS public.individual_relationship_id_seq;
DROP TABLE IF EXISTS public.individual_relationship;
DROP SEQUENCE IF EXISTS public.individual_relation_id_seq;
DROP SEQUENCE IF EXISTS public.individual_relation_gender_mapping_id_seq;
DROP TABLE IF EXISTS public.individual_relation_gender_mapping;
DROP TABLE IF EXISTS public.individual_relation;
DROP VIEW IF EXISTS public.individual_program_enrolment_search_view;
DROP TABLE IF EXISTS public.program_enrolment;
DROP SEQUENCE IF EXISTS public.individual_id_seq;
DROP TABLE IF EXISTS public.individual;
DROP SEQUENCE IF EXISTS public.index_metadata_id_seq;
DROP TABLE IF EXISTS public.index_metadata;
DROP SEQUENCE IF EXISTS public.identifier_user_assignment_id_seq;
DROP TABLE IF EXISTS public.identifier_user_assignment;
DROP SEQUENCE IF EXISTS public.identifier_source_id_seq;
DROP TABLE IF EXISTS public.identifier_source;
DROP SEQUENCE IF EXISTS public.identifier_assignment_id_seq;
DROP TABLE IF EXISTS public.identifier_assignment;
DROP SEQUENCE IF EXISTS public.groups_id_seq;
DROP TABLE IF EXISTS public.groups;
DROP SEQUENCE IF EXISTS public.group_subject_id_seq;
DROP TABLE IF EXISTS public.group_subject;
DROP SEQUENCE IF EXISTS public.group_role_id_seq;
DROP TABLE IF EXISTS public.group_role;
DROP SEQUENCE IF EXISTS public.group_privilege_id_seq;
DROP TABLE IF EXISTS public.group_privilege;
DROP SEQUENCE IF EXISTS public.group_dashboard_id_seq;
DROP TABLE IF EXISTS public.group_dashboard;
DROP SEQUENCE IF EXISTS public.gender_id_seq;
DROP TABLE IF EXISTS public.gender;
DROP SEQUENCE IF EXISTS public.form_mapping_id_seq;
DROP SEQUENCE IF EXISTS public.form_id_seq;
DROP SEQUENCE IF EXISTS public.form_element_id_seq;
DROP SEQUENCE IF EXISTS public.form_element_group_id_seq;
DROP TABLE IF EXISTS public.flyway_schema_history;
DROP SEQUENCE IF EXISTS public.flow_request_queue_id_seq;
DROP TABLE IF EXISTS public.flow_request_queue;
DROP SEQUENCE IF EXISTS public.facility_id_seq;
DROP TABLE IF EXISTS public.facility;
DROP SEQUENCE IF EXISTS public.external_system_config_id_seq;
DROP TABLE IF EXISTS public.external_system_config;
DROP SEQUENCE IF EXISTS public.export_job_parameters_id_seq;
DROP TABLE IF EXISTS public.export_job_parameters;
DROP SEQUENCE IF EXISTS public.entity_sync_status_id_seq;
DROP TABLE IF EXISTS public.entity_sync_status;
DROP SEQUENCE IF EXISTS public.entity_approval_status_id_seq;
DROP TABLE IF EXISTS public.entity_approval_status;
DROP SEQUENCE IF EXISTS public.encounter_type_id_seq;
DROP SEQUENCE IF EXISTS public.encounter_id_seq;
DROP TABLE IF EXISTS public.encounter;
DROP SEQUENCE IF EXISTS public.documentation_item_id_seq;
DROP TABLE IF EXISTS public.documentation_item;
DROP SEQUENCE IF EXISTS public.documentation_id_seq;
DROP TABLE IF EXISTS public.documentation;
DROP SEQUENCE IF EXISTS public.deps_saved_ddl_deps_id_seq;
DROP TABLE IF EXISTS public.deps_saved_ddl;
DROP SEQUENCE IF EXISTS public.decision_concept_id_seq;
DROP TABLE IF EXISTS public.decision_concept;
DROP SEQUENCE IF EXISTS public.dashboard_section_id_seq;
DROP SEQUENCE IF EXISTS public.dashboard_section_card_mapping_id_seq;
DROP TABLE IF EXISTS public.dashboard_section_card_mapping;
DROP TABLE IF EXISTS public.dashboard_section;
DROP SEQUENCE IF EXISTS public.dashboard_id_seq;
DROP SEQUENCE IF EXISTS public.dashboard_filter_id_seq;
DROP TABLE IF EXISTS public.dashboard_filter;
DROP SEQUENCE IF EXISTS public.dashboard_card_mapping_id_seq;
DROP TABLE IF EXISTS public.dashboard_card_mapping;
DROP TABLE IF EXISTS public.dashboard;
DROP SEQUENCE IF EXISTS public.custom_query_id_seq;
DROP TABLE IF EXISTS public.custom_query;
DROP SEQUENCE IF EXISTS public.concept_id_seq;
DROP SEQUENCE IF EXISTS public.concept_answer_id_seq;
DROP SEQUENCE IF EXISTS public.comment_thread_id_seq;
DROP TABLE IF EXISTS public.comment_thread;
DROP SEQUENCE IF EXISTS public.comment_id_seq;
DROP TABLE IF EXISTS public.comment;
DROP SEQUENCE IF EXISTS public.column_metadata_id_seq;
DROP TABLE IF EXISTS public.column_metadata;
DROP SEQUENCE IF EXISTS public.checklist_item_id_seq;
DROP SEQUENCE IF EXISTS public.checklist_item_detail_id_seq;
DROP TABLE IF EXISTS public.checklist_item_detail;
DROP TABLE IF EXISTS public.checklist_item;
DROP SEQUENCE IF EXISTS public.checklist_id_seq;
DROP SEQUENCE IF EXISTS public.checklist_detail_id_seq;
DROP TABLE IF EXISTS public.checklist_detail;
DROP TABLE IF EXISTS public.checklist;
DROP SEQUENCE IF EXISTS public.catchment_id_seq;
DROP SEQUENCE IF EXISTS public.catchment_address_mapping_id_seq;
DROP TABLE IF EXISTS public.catchment_address_mapping;
DROP TABLE IF EXISTS public.catchment;
...
DROP SEQUENCE IF EXISTS public.archival_config_id_seq;
DROP TABLE IF EXISTS public.storage_management_config;
DROP SEQUENCE IF EXISTS public.approval_status_id_seq;
DROP TABLE IF EXISTS public.approval_status;
DROP SEQUENCE IF EXISTS public.answer_concept_migration_id_seq;
DROP TABLE IF EXISTS public.answer_concept_migration;
DROP VIEW IF EXISTS public.all_programs;
DROP VIEW IF EXISTS public.all_operational_programs;
DROP TABLE IF EXISTS public.program;
DROP VIEW IF EXISTS public.all_operational_encounter_types;
DROP VIEW IF EXISTS public.all_form_elements;
DROP VIEW IF EXISTS public.all_form_element_groups;
DROP VIEW IF EXISTS public.all_encounter_types;
DROP TABLE IF EXISTS public.encounter_type;
DROP VIEW IF EXISTS public.all_concepts;
DROP VIEW IF EXISTS public.all_concept_answers;
DROP TABLE IF EXISTS public.form_element_group;
DROP TABLE IF EXISTS public.form_element;
DROP TABLE IF EXISTS public.concept_answer;
DROP TABLE IF EXISTS public.concept;
DROP VIEW IF EXISTS public.all_forms;
DROP TABLE IF EXISTS public.operational_program;
DROP TABLE IF EXISTS public.operational_encounter_type;
DROP TABLE IF EXISTS public.form_mapping;
DROP TABLE IF EXISTS public.form;
DROP VIEW IF EXISTS public.address_level_type_view;
DROP TABLE IF EXISTS public.organisation;
DROP SEQUENCE IF EXISTS public.address_level_type_id_seq;
DROP TABLE IF EXISTS public.address_level_type;
DROP SEQUENCE IF EXISTS public.address_level_id_seq;
DROP TABLE IF EXISTS public.address_level;
DROP SEQUENCE IF EXISTS public.account_id_seq;
DROP SEQUENCE IF EXISTS public.account_admin_id_seq;
DROP TABLE IF EXISTS public.account_admin;
DROP TABLE IF EXISTS public.account;
DROP FUNCTION IF EXISTS public.virtual_catchment_address_mapping_table_function();
DROP PROCEDURE IF EXISTS public.update_audit_columns_from_audit_table(IN table_name text);
DROP FUNCTION IF EXISTS public.title_lineage_locations_function(addressid bigint);
DROP FUNCTION IF EXISTS public.solidify_audit_columns(table_name text);
DROP FUNCTION IF EXISTS public.single_select_coded(obs text);
DROP FUNCTION IF EXISTS public.single_select_coded(obs jsonb);
DROP FUNCTION IF EXISTS public.revoke_permissions_on_account(rolename text);
DROP FUNCTION IF EXISTS public.program_encounter_sync_disabled_same_as_individual(syncdisabled boolean, programenrolmentid bigint);
DROP FUNCTION IF EXISTS public.no_op();
DROP FUNCTION IF EXISTS public.multi_select_coded(obs jsonb);
DROP FUNCTION IF EXISTS public.jsonb_object_values_contain(obs jsonb, pattern text);
DROP FUNCTION IF EXISTS public.grant_permission_on_account_admin(rolename text);
DROP FUNCTION IF EXISTS public.grant_all_on_views(view_names text[], role text);
DROP FUNCTION IF EXISTS public.grant_all_on_table(rolename text, tablename text);
DROP FUNCTION IF EXISTS public.grant_all_on_all(rolename text);
DROP FUNCTION IF EXISTS public.get_fiscal_year_range(input_date date);
DROP FUNCTION IF EXISTS public.get_coded_string_value(obs jsonb, obs_store public.hstore);
DROP FUNCTION IF EXISTS public.frequency_and_percentage(frequency_query text, denominator_query text);
DROP FUNCTION IF EXISTS public.frequency_and_percentage(frequency_query text);
DROP FUNCTION IF EXISTS public.encounter_sync_disabled_same_as_individual(syncdisabled boolean, encounterid bigint);
DROP FUNCTION IF EXISTS public.enable_rls_on_tx_table(tablename text);
DROP FUNCTION IF EXISTS public.enable_rls_on_ref_table(tablename text);
DROP FUNCTION IF EXISTS public.drop_view(schema_name text, view_name text);
DROP FUNCTION IF EXISTS public.deps_save_and_drop_dependencies(p_view_schema character varying, p_view_name character varying);
DROP FUNCTION IF EXISTS public.deps_restore_dependencies(p_view_schema character varying, p_view_name character varying);
DROP FUNCTION IF EXISTS public.delete_etl_table_metadata(in_impl_schema text, in_db_owner text, in_table_name text);
DROP FUNCTION IF EXISTS public.delete_etl_metadata_for_schema(in_impl_schema text, in_db_user text, in_db_owner text);
DROP FUNCTION IF EXISTS public.delete_etl_metadata_for_org(in_impl_schema text, in_db_user text);
DROP FUNCTION IF EXISTS public.create_view(schema_name text, view_name text, sql_query text);
DROP FUNCTION IF EXISTS public.create_implementation_schema(schema_name text, db_user text);
DROP FUNCTION IF EXISTS public.create_db_user(inrolname text, inpassword text);
DROP FUNCTION IF EXISTS public.create_audit_columns(table_name text);
DROP FUNCTION IF EXISTS public.create_audit(user_id numeric);
DROP FUNCTION IF EXISTS public.create_audit();
DROP FUNCTION IF EXISTS public.concept_name(text);
DROP FUNCTION IF EXISTS public.comment_thread_sync_disabled_same_as_individual(syncdisabled boolean, commentthreadid bigint);
DROP FUNCTION IF EXISTS public.checklist_sync_disabled_same_as_individual(syncdisabled boolean, programenrolmentid bigint);
DROP FUNCTION IF EXISTS public.checklist_item_sync_disabled_same_as_individual(syncdisabled boolean, checklistid bigint);
DROP FUNCTION IF EXISTS public.check_group_privilege_uniqueness(groupprivilegeid integer, groupid integer, privilegeid integer, subjecttypeid integer, programid integer, programencountertypeid integer, encountertypeid integer, checklistdetailid integer, implversion integer);
DROP FUNCTION IF EXISTS public.check_form_mapping_uniqueness(organisationid integer, subjecttypeid integer, entityid bigint, observationstypeentityid integer, tasktypeid integer, formid bigint, formmappingid integer, implversion integer, formmappingisvoided boolean);
DROP FUNCTION IF EXISTS public.check_form_mapping_uniqueness(organisationid integer, subjecttypeid integer, entityid bigint, observationstypeentityid integer, tasktypeid integer, formid bigint, formmappingid integer, implversion integer);
DROP FUNCTION IF EXISTS public.audit_table_trigger();
DROP FUNCTION IF EXISTS public.assert_subject_with_same_sync_disabled(syncdisabled boolean, subjectid bigint);
DROP FUNCTION IF EXISTS public.assert_one_of_subjects_with_sync_disabled(syncdisabled boolean, subjectid1 bigint, subjectid2 bigint);
DROP FUNCTION IF EXISTS public.archive_sync_telemetry(olderthan date);
DROP FUNCTION IF EXISTS public.append_manual_update_history(current_value text, text_to_be_added text);
...
\unrestrict luVrFkPSmYIgahapZssZkhyxFlEkPphhh1NJfgaL5GmZf9inW1EvDeYo2EexBw2
